...
/*
* Modified by Andrei Chubarau in February 2017 for easier access to Voronoi graph structure.
* all modifications marked by "// MODIFIED" ***modified code*** "// MODIFIED END" with no quotations
*/
...
namespace Voronoi2 {
    ...
    public class Voronoi {
        ...
        public void generateVoronoi(double[] xValuesIn, double[] yValuesIn, double minX, double maxX, double minY, double maxY) {
            ...
            allSites.Sort(new SiteSorterSiteNBR());

            voronoiGraph = new VoronoiGraph(allEdges, allSites);
        }
